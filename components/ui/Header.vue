<template>
  <!-- <nav class="container mx-auto px-4 sm:px-6 lg:px-8 justify-items-end space-x-8 py-6 pr-6">
    <div class="">
      <nuxt-link to="/" class="font-display uppercase text-m-blue-3 hover:border-b-2 hover:border-current">
        Home
      </nuxt-link> -->
